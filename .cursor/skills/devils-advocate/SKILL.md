...
description: Forces adversarial reasoning before committing to decisions. Triggers on architectural choices, approach selection, and planning phases to prevent premature commitment bias. Use when asked to challenge a plan, poke holes, or play devil's advocate.
---
...
Activate when:
- Choosing between architectural approaches, libraries, or tools
- Planning implementation strategy or making trade-off decisions
- During Plan / architect / blueprint workflows
